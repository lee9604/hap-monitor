 ...
 *
 */
public interface DmsCameraService  {
     ...
     */
     DmsCameraBean add(DmsCameraBean dmsCameraBean);
     ...
     * @return 如果成功返回对应bean，否则返回null
     */
     DmsCameraBean update(DmsCameraBean dmsCameraBean);
     ...
     * @return 如果成功返回对应bean，否则返回null
     */
    DmsCameraBean delete(DmsCameraBean dmsCameraBean);
     ...
     * @return 如果成功返回对应bean，否则返回null
     */
    DmsCameraBean find(DmsCameraBean dmsCameraBean);
     ...
     */
     DmsCameraBean find(String code);
    ...
    /**
     * 统计所有记录
     * @param dmsCameraBean 统计参数
     * @return 记录存在返回对应的bean集合，否则返回空集合
     */
     Long countAll(DmsCameraBean dmsCameraBean);
    ...
    /**
     * 批量删除
     * @param dmsCameraBeans 批量删除元素集合
     */
     void batchDelete(List<DmsCameraBean> dmsCameraBeans);
